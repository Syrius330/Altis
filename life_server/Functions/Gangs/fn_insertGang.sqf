...
if(count _queryResult != 0) exitWith {
	[[1,"Es existiert bereits eine Gang mit diesen Namen."],"life_fnc_broadcast",_ownerID,false] spawn life_fnc_MP;
...
if(count _queryResult != 0) exitWith {
	[[1,"Du bist bereits in einer Gang, verlasse zuerst deine alte Gang."],"life_fnc_broadcast",_ownerID,false] spawn life_fnc_MP;
	[["life_action_gangInUse",nil,missionNamespace],"life_fnc_netSetVar",_ownerID,false] spawn life_fnc_MP;
};
