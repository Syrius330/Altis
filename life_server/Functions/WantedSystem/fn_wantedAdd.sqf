...
switch(_type) do
{
	case "187V": {_type = ["Fahrlässiger Mord",6500]};
	case "187": {_type = ["Mord",8500]};
	case "901": {_type = ["Gefängnnissausbruch",4500]};
	case "261": {_type = ["Vergewaltigung",5000]}; //What type of sick bastard would add this?
	case "261A": {_type = ["Versuchte Vergewaltigung",3000]};
	case "215": {_type = ["Versuchter Mord mit Fahrzeug",2000]};
	...
	case "487": {_type = ["Mord mit Fahrzeug",1500]};
